...
import me.hungaz.ZCord.utils.SkidStatics;
...
public class PipelineUtils
{
    ...
    public static final class Base extends ChannelInitializer<Channel>
    {
        ...
        public void initChannel(Channel ch) throws Exception
        {
            ...
            ch.config().setOption( ChannelOption.TCP_NODELAY, true ); //ZCord //WaterFall backport
            // FlameCord - TCP Fast Open
            ch.config().setOption( ChannelOption.TCP_FASTOPEN, 3 );
        ...
        public void exceptionCaught(final ChannelHandlerContext ctx, final Throwable cause) throws Exception {
            if(Settings.IMP.LOG_NETTY_STACKTRACE) {
