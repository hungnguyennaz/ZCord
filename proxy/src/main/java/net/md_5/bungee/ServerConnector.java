...
public class ServerConnector extends PacketHandler
{
    ...
    public void handle(Login login) throws Exception
    {
        ...
        if ( user.isNeedLogin() || !( login.getDimension() instanceof Integer ) ) //ZCord
        {
            ...
            if ( !user.isNeedLogin() ) //ZCord //if false, means user came from captcha or server switch
            {
                if ( user.getServer() != null ) //ZCord
                {
                    user.getServer().setObsolete( true ); //ZCord
                ...
                if ( user.getServer() != null ) //ZCord
                {
                    user.getServer().disconnect( "Quitting" ); //ZCord
                }
            } else if ( user.isNeedLogin() ) //ZCord
            {
        ...
        } else
        {
            ...
            if ( this.user.getServer() != null ) //ZCord
            {
                this.user.getServer().disconnect( "Quitting" ); //ZCord
            }
        }
