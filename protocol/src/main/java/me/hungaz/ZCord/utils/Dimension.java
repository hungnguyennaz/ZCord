...
public enum Dimension {
    ...
    private CompoundTag createChatRegistry(int protocol) {
        ...
        if (protocol >= ProtocolConstants.MINECRAFT_1_19_1) {
            systemChatData.add("translation_key", new StringTag("chat.type.system"));
            systemChatData.add("parameters", new ListTag(Tag.TAG_STRING, Arrays.asList()));
        }
        ...
        if (protocol < ProtocolConstants.MINECRAFT_1_19_1) {
            ...
            narration.add("parameters", new ListTag(Tag.TAG_STRING, Arrays.asList()));
        }
        ...
        if (protocol >= ProtocolConstants.MINECRAFT_1_19_1) {
            ...
            gameInfoChat.add("parameters", new ListTag(Tag.TAG_STRING, Arrays.asList()));
            ...
            gameInfoNarration.add("parameters", new ListTag(Tag.TAG_STRING, Arrays.asList()));
        ...
        root.add("value", new ListTag(Tag.TAG_COMPOUND, Arrays.asList(systemChat, gameInfo)));
        return root;
    }
