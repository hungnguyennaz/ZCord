...
import me.hungaz.ZCord.packets.Player;
...
public enum Protocol
{
    ...
    /*========================================================================*/
    public final DirectionData TO_SERVER = new DirectionData( this, ProtocolConstants.Direction.TO_SERVER ); //ZCord -> public
    public final DirectionData TO_CLIENT = new DirectionData( this, ProtocolConstants.Direction.TO_CLIENT ); //ZCord -> public
    ...
    public static final class DirectionData //ZCord -> public
    {
        ...
        private void registerPacket(Class<? extends DefinedPacket> packetClass, ProtocolMapping... mappings) //ZCord
        {
